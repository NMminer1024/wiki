...
| -------------------------------------------- | -------------------------------------------------------------- |
| Get a board mining ASAP                      | [Quick Start](./getting-started/quick-start.md)                |
| Pick a board                                 | [Hardware Overview](./hardware/overview.md)                    |
| Learn buttons & screen pages                 | [User Guide › Buttons](./user-guide/buttons.md)                |
...
- 🏊 **SoloBTC Pool**: [solobtc.nmminer.com](https://solobtc.nmminer.com)