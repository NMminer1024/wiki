---
sidebar_position: 3
title: Placas ESP32-S3
---

# Placas ESP32-S3

ESP32-S3 tiene doble núcleo Xtensa LX7 más una ISA vectorial compatible con SIMD. NMMiner alcanza un pico de **~400 KH/s** en S3.

| Placa                                        | Tasa de hash  | Chip          |
| -------------------------------------------- | ------------- | ------------- |
...
| Waveshare ESP32 S3 LCD 1.47 (USB-A)                                              | **384,5 KH/s** | ESP32-S3R8  |
| Waveshare ESP32 S3 LCD 1.47B (USB-C)                                             | **383,5 KH/s** | ESP32-S3R8  |
| Waveshare ESP32 S3 Touch LCD 3.5                                                 | **380,3 KH/s** | ESP32-S3R8  |
