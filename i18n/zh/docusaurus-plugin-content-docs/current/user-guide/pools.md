...
两个都是 NMMiner 自家运营，基于 public-pool fork，对几百 KH/s 的小矿工特别友好。控制台：[solobtc.nmminer.com](https://solobtc.nmminer.com)。
...
NMMiner 算力是几百 KH/s 级别。商业大池要求 share 最低难度很高 — 会拒掉你所有的提交。请坚持 NMMiner SoloBTC、public-pool 系或社区 SoloBTC 矿池 — 任何接受极小 share 难度的端点都行。